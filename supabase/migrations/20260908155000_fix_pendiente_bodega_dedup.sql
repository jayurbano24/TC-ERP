-- =============================================================================
-- Fix Pendiente Bodega: no sumar CAC (filas bandeja) + BO (OS series) — duplicaba ~3k.
-- SSOT tile: pendiente_bodega_os = OS únicas en bandeja CAC ∪ RECEPCIONADO_BODEGA_GENERAL.
