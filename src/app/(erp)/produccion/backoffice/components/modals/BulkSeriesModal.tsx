    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#181c3a]/80 backdrop-blur-xl p-6">
      <Card className="w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border-none animate-rise-in p-0">
        <div className="bg-[#181c3a] p-7 text-white flex justify-between items-center">
          ...
          <button type="button" onClick={onClose} className="text-slate-300 hover:text-[#181c3a]">
        ...
        <div className="p-7 space-y-4">
          ...
          <textarea
            ...
            rows={10}
            className="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-mono text-xs outline-none focus:border-[#2ec4f1] resize-none"
            placeholder="SN001&#10;SN002&#10;SN003"
          />
          <div className="flex gap-4">
            ...
            <Button
              variant="primary"
              className="flex-[2] h-14 rounded-2xl font-black uppercase text-[10px] bg-[#181c3a] text-white shadow-xl shadow-blue-500/10"
              onClick={onImport}
            >
              Procesar e Importar
            </Button>
