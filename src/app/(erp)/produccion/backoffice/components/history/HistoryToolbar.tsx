  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 px-2 mb-10">
      ...
      <div className="flex flex-wrap gap-4 items-center">
        <div className="flex items-center gap-4 bg-[var(--surface)] text-[var(--foreground)] p-2.5 rounded-3xl border border-[var(--border)] shadow-sm px-6">
          <div className="flex flex-col">
            <label className="text-[8px] font-black text-[var(--muted)] uppercase tracking-widest mb-0.5">Desde</label>
            <input
              type="date"
              className="text-[11px] font-bold text-[var(--foreground)] bg-transparent outline-none cursor-pointer"
          ...
          <div className="flex flex-col">
            <label className="text-[8px] font-black text-[var(--muted)] uppercase tracking-widest mb-0.5">Hasta</label>
            <input
              type="date"
              className="text-[11px] font-bold text-[var(--foreground)] bg-transparent outline-none cursor-pointer"
              value={dateFilterTo}
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-3 px-8 h-16 bg-amber-500 text-[#181c3a] rounded-3xl text-[10px] font-black uppercase tracking-widest hover:bg-amber-600 transition-all shadow-xl shadow-amber-500/20 active:scale-95"
          >
