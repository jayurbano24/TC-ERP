-- Motor 4 — refresh_service_order_stage_summary v2
-- Seed histórico CAC desde cac_tray_units + resolver OS multi-vía en audit.
...
-- Población inicial con la nueva lógica (seed bandeja CAC + audit taller)
