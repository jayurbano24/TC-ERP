...
-- La migración 152000 llamaba is_service_order_dispatched(id) por cada OS → RPC
-- fallaba → UI en fallback (solo taller, resto en cero, sin ubicación ~43k).
-- =============================================================================
...
-- Solo reemplaza el CTE despachado_os (resto = migración 152000 / 44500).
