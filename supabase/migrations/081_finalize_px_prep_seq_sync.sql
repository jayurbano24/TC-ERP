-- 081: Prep mínimo — resincroniza secuencia, evita bucle infinito en box_code, sin COUNT pesado
...
BEGIN
  ...
  LOOP
    ...
    IF v_attempts > 50 THEN
      RAISE EXCEPTION 'BOX_CODE_EXHAUSTED: No se pudo asignar código único tras 50 intentos.';
    END IF;
