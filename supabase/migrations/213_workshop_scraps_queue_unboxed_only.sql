-- =============================================================================
-- 213 — Reaplica cola SCRAPS: irreparables SIN caja (idempotente de 200)
-- Si 200 no se aplicó en el proyecto, el contador SCRAPS incluye cajas ya
-- ingresadas a Bodega SCRAPS. Esta migración garantiza a forzar el filtro.
-- =============================================================================
