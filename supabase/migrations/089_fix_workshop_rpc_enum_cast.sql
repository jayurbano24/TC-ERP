-- =============================================================================
-- 089 — Fix RPC taller: current_status es enum series_status, no text
-- Aplica si 087 falló en count_workshop_os_by_status / workshop_list_os_queue_page.
-- Patrón: comparar vía ::text (igual que 055_warehouse_sap_sync_chg002).
-- =============================================================================
...
-- count_workshop_os_all_tabs usa literales enum (OK); re-create por idempotencia post-087 parcial
