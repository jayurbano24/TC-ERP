-- =============================================================================
-- Cierra gap "Sin ubicación": reac suelto + recepcionado BO + sin serie en planta.
-- Residual típico post-153000: ready_to_dispatch sin caja y RECEPCIONADO_BODEGA_GENERAL
