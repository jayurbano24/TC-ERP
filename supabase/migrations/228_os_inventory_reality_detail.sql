-- =============================================================================
-- 228 — Inventario OS realidad por módulo (SSOT detalle).
-- Reemplaza count_os_inventory_modules con desglose alineado al diagnóstico.
-- Backoffice = bandeja CAC pendiente Bodega Central (no ledger series inflado).
-- =============================================================================
...
COMMENT ON FUNCTION public.count_os_inventory_modules() IS
  'Inventario OS SSOT: BO=cac_tray pendiente bodega; taller por etapa; scraps piso vs caja.';
