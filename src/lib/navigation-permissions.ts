...
const MODULE_ALIASES: Record<string, string[]> = {
  ...
  Bodega: ['Bodega', 'Gestión de Bodega', 'Bodega de Salida', 'Bodega SCRAPS', 'Bodega de Partes'],
  'Bodega Salida': ['Bodega', 'Gestión de Bodega', 'Bodega de Salida', 'Despacho', 'Despacho Final'],
  'Bodega SCRAPS': ['Bodega', 'Gestión de Bodega', 'Bodega SCRAPS', 'Taller', 'Taller Técnico'],
  'Bodega de Partes': ['Bodega', 'Gestión de Bodega', 'Bodega de Partes'],
...
export function canViewNavItem(item: NavigationItem, authz: NavAuthz | null): boolean {
  ...
  if (key === 'Autorizaciones' || key === 'Salud') return false;
