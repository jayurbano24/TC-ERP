...
export const STATIC_REPORT_CATALOG = [
  ...
  {
    code: 'CENAM_REFURBISHED',
    name: 'CENAM Refurbished',
    category: 'Operaciones',
    description:
      'ETL por mes (4 libros): ingresos PX/CAC, entregado RP/RC, irreparables y matriz resumen. Requiere mes específico.',
    columns: [
      'Año',
      'País',
      'Mes',
